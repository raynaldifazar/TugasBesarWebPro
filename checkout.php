...
//jika tidak ada session pelanggan di checkout(keranjang kosong), maka dilarikan ke halaman home
if (empty($_SESSION["keranjang"]) or !isset($_SESSION["keranjang"])) {
    echo "<script>alert('Keranjang kosong, silahkan pilih produk terlebih dahulu'); </script>";
    echo "<script>location='index.php'; </script>";
}

//jika tidak ada session pelanggan di checkout (belum login). maka dilarikan ke halaman login
...
<body>
    ...
    <section class="konten">
        <div class="container">
            <h1><b><u>Checkout Pesanan</u></b></h1>
            <hr>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="alamat_pengiriman" placeholder="Masukkan alamat lengkap pengiriman (berserta kode pos)"></textarea>
                </div>
            ...
            if (isset($_POST["checkout"])) {
                ...
                $koneksi->query("INSERT INTO pembelian (
                    ...
                    provinsi,distrik,tipe,kodepos,ekspedisi,paket,ongkir,estimasi) VALUES 
                    ('$id_pelanggan','$tanggal_pembelian','$total_pembelian','$alamat_pengiriman',
                    '$totalberat','$provinsi','$tipe','$distrik','$kodepos','$ekspedisi','$paket',
                    '$ongkir','$estimasi')");
...
<script>
    $(document).ready(function() {
        ...
        $("select[name=nama_ekspedisi]").on("change", function() {
            ...
            //mendapatkan distrik yg dipilih
            ...
            $.ajax({
                ...
                success: function(hasil_paket) {
                    ...
                    //letakkan nama ekspedisi terpilih di inputan ekspedisi
